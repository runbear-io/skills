...
Examples:
- `/dispatch-discord:dispatch-discord start /Users/me/my-project`
- `/dispatch-discord:dispatch-discord stop`
- `/dispatch-discord:dispatch-discord` (defaults to start)
...
```
If missing, tell the user to run `/dispatch-discord:setup-discord` first.
